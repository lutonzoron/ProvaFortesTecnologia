...
begin
   ...
   begin
      MessageBox(Handle, 'Não há tanque para editar!', 'Sistema Gerenciador de Posto', MB_ICONEXCLAMATION + MB_OK);
      exit;
   end;
...
begin
   if(FDQ_Tanque.IsEmpty)then
   begin
      MessageBox(Handle, 'Não há tanque para excluir!', 'Sistema Gerenciador de Posto', MB_ICONEXCLAMATION + MB_OK);
      exit;
   end;
